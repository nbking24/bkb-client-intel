# BKB Client Intel Ã¢ÂÂ Architecture & System Reference
...
```
app/
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ page.tsx                          # Redirects to /dashboard (legacy chat UI at page-legacy.tsx)
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ layout.tsx                        # Root HTML layout + viewport meta
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ hooks/
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ useAskAgent.ts               # Ã¢ÂÂ Shared hook for Ask Agent (desktop + mobile)
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ m/                                # Mobile routes (NO dashboard chrome)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ layout.tsx                    # Minimal full-screen layout
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ask/page.tsx                  # Mobile Ask Agent (/m/ask)
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ dashboard/
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ layout.tsx                    # Dashboard shell (header + 4-item sidebar + Ask Agent button + auth gate)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ page.tsx                      # Overview Ã¢ÂÂ time-aware AI briefing, tasks, calendar, email, chat
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ login/page.tsx                # Per-user PIN login (setup + sign-in flow)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ components/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ AskAgentPanel.tsx         # Slide-out Ask Agent panel (Know-it-All / Approved Specs toggle)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ask/page.tsx                  # Desktop Ask Agent (/dashboard/ask)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ documents/page.tsx            # Document intelligence (placeholder)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ precon/                       # Pre-Construction module
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ page.tsx                  # Agent recommendations + orphan panel
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ [jobId]/page.tsx          # Individual job schedule/phases
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ audit/page.tsx            # Audit Ã¢ÂÂ misplaced/orphan task analysis
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ setup/page.tsx            # Survey-based schedule setup wizard
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ OrphanTaskPanel.tsx       # Orphan task reassignment component
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ invoicing/page.tsx             # Invoicing Health Dashboard (health-sorted cards, invoice details)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ spec-writer/
Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ page.tsx                  # Quick Spec Writer (upload + generate)
Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ contract/page.tsx         # Contract Spec Builder (cost-item based)
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ api/
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ chat/route.ts                 # Ã¢ÂÂ Main chat endpoint Ã¢ÂÂ agent router
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ auth/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts                  # Per-user PIN auth (login, setup, check)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ google-callback/route.ts  # Google OAuth callback (one-time setup for Gmail/Calendar)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ extract-pdf/route.ts          # PDF Ã¢ÂÂ text extraction (shared)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ conversations/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts                  # List/create conversations
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ [id]/route.ts            # Get/add messages/delete conversation
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ setup/route.ts           # Initialize conversation tables
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ lib/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ agents/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ router.ts            # Ã¢ÂÂ Agent routing Ã¢ÂÂ canHandle() scoring
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ types.ts             # Shared types, stage mappings
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ know-it-all.ts       # Ã¢ÂÂ Unified Ask agent (Q&A + JT read/write, 39 tools)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ jt-entry.ts          # (DEPRECATED Ã¢ÂÂ merged into know-it-all)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ project-details.ts   # Project specs agent (PAVE cost items)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ auth.ts                  # validateAuth() helper
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ghl.ts                   # GHL API service (API routes)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ jobtread.ts              # JobTread PAVE service (API routes)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ supabase.ts              # Supabase service-role client
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ sync/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts                 # Main sync (GHL + JT Ã¢ÂÂ Supabase)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ force/route.ts           # Force-sync (bypass throttle)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ backfill/route.ts        # Historical batch sync
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ghl/[contactId]/route.ts # Single GHL contact sync
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ job/[jobId]/route.ts     # Single JT job sync
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ spec-writer/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ generate/route.ts        # Quick spec generation
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ questions/route.ts       # Category Q&A generation
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ contract/
Ã¢ÂÂ   Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ generate/route.ts    # Contract spec generation
Ã¢ÂÂ   Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ extract-pdf/route.ts # Contract PDF extraction
Ã¢ÂÂ   Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ budget/route.ts      # Cost hierarchy builder
Ã¢ÂÂ   Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ questions/route.ts   # Contract Q&A generation
Ã¢ÂÂ   Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ save/route.ts        # Save spec to JT cost group
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ dashboard/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ invoicing/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts             # Invoicing health data endpoint (cached)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ create-task/route.ts # Create $ schedule task for unmatched draft invoices
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ create-invoice/route.ts        # One-click draft invoice for Cost-Plus jobs (with AI descriptions)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ create-billable-invoice/route.ts # One-click draft invoice for Fixed-Price CC23 billable items
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ reorganize-invoice/route.ts    # Reorganize Cost-Plus invoice into BKB 3-group format
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ queue-invoice/route.ts         # Queue invoice creation request (Supabase Ã¢ÂÂ scheduled task)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ projects/route.ts        # Active projects list
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ tasks/route.ts           # Task list + PATCH for complete/update
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ chat/route.ts           # Dashboard chat widget endpoint (separate from Ask Agent)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ inbox-cleanup/route.ts  # AI-powered email triage + archive
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ quick-action/route.ts   # Do Now action handler (Gmail draft creation)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ overview/route.ts       # Dashboard overview data + AI analysis (cached)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ schedule/route.ts        # Schedule multi-view endpoint
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ schedule-setup/route.ts  # Survey-based schedule builder
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ agent/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ design-manager/route.ts  # Design Manager analysis + actions
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ invoicing/route.ts       # Invoicing health Claude analysis
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ pml/                            # Ã¢ÂÂ Project Memory Layer (PLANNED)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts                    # CRUD for project_events (GET list, POST create)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ [eventId]/route.ts          # GET/PATCH single event (resolve, update)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ open-items/route.ts         # GET all unresolved open items
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ cron/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ design-agent/route.ts    # Daily 6 AM Ã¢ÂÂ design analysis
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ invoicing-health/route.ts # Daily 6 AM Ã¢ÂÂ invoicing data refresh
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ inbox-cleanup/route.ts   # Hourly Ã¢ÂÂ AI email triage + auto-archive
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ gmail-to-pml/route.ts    # Ã¢ÂÂ Hourly Ã¢ÂÂ Gmail sent+inbox Ã¢ÂÂ project_events (PLANNED)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ sync-incremental/route.ts # Daily 5 AM Ã¢ÂÂ incremental sync
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ contacts/route.ts            # Contact search
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ notes/route.ts               # Create contact notes (chunked)
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ opportunities/route.ts       # Opportunities with pipeline data
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ query/route.ts               # General-purpose Q&A endpoint
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ debug/route.ts               # Environment health check
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ jobtread-test/route.ts       # PAVE API diagnostic
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ lib/
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ project-memory.ts             # Ã¢ÂÂ PML service: queries, event creation, resolution, matching (PLANNED)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ gmail-sync.ts                 # Ã¢ÂÂ Gmail sent+inbox sync, thread tracking, reply detection (PLANNED)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ invoicing-health.ts           # Invoicing health analysis (contract + cost-plus, CC23 billable, released invoices)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ google-api.ts                # Google OAuth2 helper Ã¢ÂÂ Gmail inbox/archive/drafts + Calendar events
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ dashboard-data.ts            # Dashboard data aggregation (JT tasks, comments, Gmail, Calendar, time context)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ dashboard-analysis.ts        # AI analysis engine Ã¢ÂÂ time-aware briefings, quick actions, tomorrow preview
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ nathan-voice.ts              # Nathan's brand voice rules for AI writing (condensed from v5 doc)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ nathan-brand-voice.md        # Full brand voice document (reference)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ bkb-spec-guide.ts            # BKB 23-category spec system + prompts
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ bkb-standards.ts             # Standard construction practices
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ bkb-brand-voice.ts           # Brand voice + email writing guide
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ cache.ts                     # Supabase cache read/write/clear
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ constants.ts                 # Colors, phases, statuses, rules
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ contact-mapper.ts            # Fuzzy name Ã¢ÂÂ GHL contact matching
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ design-agent.ts              # Design Manager data + analysis
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ghl.ts                       # GHL API service (expanded)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ jobtread.ts                  # JobTread PAVE service (expanded)
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ supabase.ts                  # Supabase client factory
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ schedule-templates.ts        # 9-phase schedule template + tasks
    Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ survey-templates.ts          # Project scope survey definitions
```

---

## 3. Agent System Ã¢ÂÂ HOW IT WORKS
...
```
User message Ã¢ÂÂ /api/chat Ã¢ÂÂ router.ts Ã¢ÂÂ canHandle() on each agent Ã¢ÂÂ highest score wins Ã¢ÂÂ agent.handle()
```

- Each agent has a `canHandle(message)` function returning a score 0Ã¢ÂÂ1
...
|-------|------|-------------|-------------|
| **Know-it-All** | `know-it-all.ts` | 0.05Ã¢ÂÂ0.95 | Unified Ask agent Ã¢ÂÂ full JT read+write (39 tools), Supabase + GHL search, email drafting, material specs, task creation/updates |
| **Project Details** | `project-details.ts` | 0.1Ã¢ÂÂ0.9 | Answers questions about specs from project's Specifications URL via PAVE cost items |
...
- Know-it-All handles ALL task operations (read + write) Ã¢ÂÂ there is no separate write agent
...
**Field mapping** (JSON Ã¢ÂÂ `create_phase_task` tool params):
...
- `CONFIRMATION_PATTERN` Ã¢ÂÂ "yes", "ok", "proceed", etc.
- `EXTENDED_CONFIRM_PATTERN` Ã¢ÂÂ "Yes, proceed but ..."
- `APPROVED_TASK_PATTERN` Ã¢ÂÂ messages containing `[APPROVED TASK DATA`

---

## 4. Ask Agent Ã¢ÂÂ Shared Hook Architecture
...
- **Vendor Estimate Mode**: When a PDF is a vendor estimate/invoice, the system prompt instructs Claude to extract actual product names, sizes, colors Ã¢ÂÂ NOT generic "tbd per owner selection" boilerplate
...
### 5.3 Key Files
- `app/lib/bkb-spec-guide.ts` Ã¢ÂÂ Categories 01Ã¢ÂÂ23, system prompts
- `app/lib/bkb-standards.ts` Ã¢ÂÂ Standard construction practices by category
- `app/api/spec-writer/generate/route.ts` Ã¢ÂÂ Quick spec endpoint (has vendor estimate mode)

---

## 6. Specs Agent (Project Details) Ã¢ÂÂ Data Flow
...
1. **Fetch all budget cost items** via `getCostItemsLightForJob(jobId)` Ã¢ÂÂ returns every cost item in the job's budget with cost groups, files, and document references
2. **Identify approved documents** Ã¢ÂÂ filters for customer orders/invoices with `status === 'approved'` or `status === 'pending'`
3. **Filter budget items** Ã¢ÂÂ keeps only items that reference an approved document ID
4. **Fetch document-level items** via `getDocumentCostItemsLightById(docId)` for each approved document Ã¢ÂÂ this catches Change Order items whose budget-level entries lack a document reference
5. **Filter out unselected options** Ã¢ÂÂ uses PAVE `isSelected` field to exclude items the client did NOT select (see below)
6. **Merge** Ã¢ÂÂ combines filtered budget items + selected document-level items (deduped by ID)
7. **Build context string** Ã¢ÂÂ formats items with names, descriptions, cost codes, cost groups, and file links
8. **Append file links** Ã¢ÂÂ file URLs use the JobTread CDN pattern: `https://cdn.jobtread.com/files/{fileId}` (appended server-side, not from PAVE URL field)

### 6.2 Document Options & `isSelected` Filtering

JobTread documents (estimates, contracts) can have **options** Ã¢ÂÂ alternative cost groups where the client selects which ones they want. For example, a flooring section might offer "Alpine Quartzite" and "Sterling Quartzite" as two options, but the client only selects one.
...
- `isSelected` on budget-level (job) cost items always returns `false` Ã¢ÂÂ it's only meaningful at the document level
...
| File | Role |
|------|------|
| `app/api/lib/agents/project-details.ts` | Specs agent Ã¢ÂÂ system prompt, `get_project_details` tool, context builder |
...
```
Daily 1 AM EST cron Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ /api/cron/invoicing-health Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ buildInvoicingContext() Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Supabase cache
                                                                                          Ã¢ÂÂ
User visits dashboard Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ /api/dashboard/invoicing?cached=true Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ reads Supabase cache Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ UI
User clicks Refresh   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ /api/dashboard/invoicing?refresh=true Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ fresh buildInvoicingContext() Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ UI + cache
```

### 6.2 Data Layer (`app/lib/invoicing-health.ts`)

Core analysis function `buildInvoicingContext()` fetches all active jobs via PAVE API, classifies by native `priceType` field (`fixed` Ã¢ÂÂ Fixed-Price, `costPlus` Ã¢ÂÂ Cost-Plus), then runs type-specific analyzers:

**analyzeContractJob()** Ã¢ÂÂ Fixed-Price jobs:
- Milestone tracking via `$` prefix schedule tasks (approaching, overdue)
- Draft invoice Ã¢ÂÂ `$` task matching (fuzzy name match, extracts parenthesized labels)
...
- Unbilled labor hours: CC23 time entries minus CC23 invoice items where name contains "labor" (name-based filter Ã¢ÂÂ labor invoice items use costType "Other", not "Labor")
- Denied vendor bills (deleted in JobTread) are excluded via `status !== 'denied'`
- Released invoices (approved Ã¢ÂÂ paid, pending Ã¢ÂÂ open) with amounts
...
**analyzeCostPlusJob()** Ã¢ÂÂ Cost-Plus jobs:
...
**findBillableItems()** Ã¢ÂÂ CC23 billable items panel (non-contract jobs only)
...
- **"Create Draft Invoice" button**: One-click creates a draft customer invoice in JobTread with all unbilled budget items (excludes $0.00 placeholders). Groups: Materials first Ã¢ÂÂ Admin Ã¢ÂÂ Subcontractor Ã¢ÂÂ Other Ã¢ÂÂ Labor last. Material items get auto-generated descriptions from cost code info.
...
| `projects` | Maps JT jobs Ã¢ÂÂ GHL contacts |
...
### 8.3 Data Flow
```
GHL API Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ ghl_messages, ghl_notes (Supabase cache)
JT API  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ jt_comments, jt_daily_logs (Supabase cache)
                    Ã¢ÂÂ
...
2. **Two copies of service files**: GHL and JobTread each have TWO service files Ã¢ÂÂ one in `app/api/lib/` (for API routes) and one in `app/lib/` (for expanded platform use). They are NOT the same file.

3. **Spec Writer Ã¢ÂÂ  Chat Agents**: The Quick Spec Writer (`/dashboard/spec-writer`) has its own generate endpoint (`/api/spec-writer/generate`) with its own system prompt. It does NOT use the chat agent system. Don't modify agents when the spec writer needs fixing.
...
7. **Editable confirmation cards can cause stale data**: When the user edits the phase dropdown on a TaskConfirmCard, the `phaseId` from the original suggestion becomes stale. The hook deletes the old `phaseId` and sets `phaseChanged: true` Ã¢ÂÂ Know-it-All must then look up the correct phase ID via `get_job_schedule`. If this logic is bypassed, tasks get created as orphans.
...
9. **Tool param names don't match JSON keys**: The confirmation card JSON uses `assignee` but the tool expects `assignTo`. Similarly `phaseId` maps to `parentGroupId`. The Know-it-All system prompt has an explicit mapping table Ã¢ÂÂ if you modify the tool schema, update the mapping too.
...
14. **Contract vs Cost-Plus logic must stay separate**: Changes to `analyzeContractJob()` must NOT affect `analyzeCostPlusJob()` or vice versa. They interpret the same data differently Ã¢ÂÂ contract jobs only count `type === 'Billable'` time entries and CC23 costs; cost-plus jobs count ALL time entries and ALL vendor bill costs. Nathan has explicitly warned about this multiple times.

15. **Fixed-Price billable detection uses costCode + costType, NOT name prefix**: For Fixed-Price jobs (`analyzeContractJob`), billable items are identified by `costCode.number === '23'` AND `costType.name` being "Materials" or "Subcontractor". Do NOT use `name.startsWith('23 Billable')` Ã¢ÂÂ that misses items with non-standard names. Cost-Plus jobs (`analyzeCostPlusJob`) and `findBillableItems()` still use the old name prefix filter `BILLABLE_NAME_PREFIX`.
...
17. **Deleted vendor bills have `status: 'denied'`**: When bills are deleted in JobTread, they aren't removed from the API Ã¢ÂÂ they get `status: 'denied'`. All analysis functions must filter these out with `status !== 'denied'` to avoid counting deleted bill costs in totals.
...
22. **Cost-Plus = ALL hours billable, Fixed-Price = ONLY CC23 hours**: This is a critical business rule. Cost-Plus jobs bill all time entries regardless of cost code. Fixed-Price jobs ONLY bill time entries tagged to Cost Code 23. Nathan has explicitly corrected this twice Ã¢ÂÂ do not change this behavior.

23. **PML: Never auto-send follow-up emails**: The Project Memory Layer may surface open items where an email was sent but no reply received. Follow-up draft emails must ALWAYS be suggested as "Do Now" actions requiring Nathan's approval Ã¢ÂÂ NEVER auto-sent. The system cannot know if the answer came via phone call, text, or in-person conversation. This is a hard rule.
...
26. **PML: Email-to-project matching is probabilistic**: Not every email will match a project. Events with `job_id: null` are valid Ã¢ÂÂ they still appear in global agent context. Nathan can manually link them later via conversation. Do not force-match ambiguous emails.

27. **PAVE sub-collections cap at 100 entries, oldest-first, no sort/offset**: `job.timeEntries`, `job.costItems`, and similar sub-collections return a maximum of 100 entries in creation order (oldest first). PAVE does NOT support `offset`, `after`, `pageInfo`, `sort`, or `orderBy` on these sub-collections. To paginate, use `where: ["id", ">", lastId]` which exploits PAVE's deterministic ID ordering. Always paginate any sub-collection that could exceed 100 entries Ã¢ÂÂ silently losing the newest entries causes subtle data bugs (e.g., Halvorsen's 102.5 CC23 hours showing as 0 because all 18 entries fell past position 100).
...
- The dashboard briefing only sees the last 3 days of inbox emails and 7 days of JT comments Ã¢ÂÂ no persistent memory
...
create table project_events (
  ...
  related_event_id uuid references project_events(id),  -- links answerÃ¢ÂÂquestion, replyÃ¢ÂÂoriginal
...
### 15.3 Data Flows Ã¢ÂÂ How Information Enters PML
...
- Agent processes the transcript with Claude to extract:
  ...
  - `commitments`: things promised to the client or by the client Ã¢ÂÂ logged as open items if follow-up is needed
...
### 15.4 Agent Integration Ã¢ÂÂ Know-it-All Tools
...
- Use case: "What's happening with Oakes?" Ã¢ÂÂ agent pulls full communication timeline

**`log_project_event`**
- Input: `jobId`, `channel`, `event_type`, `summary`, `detail` (optional), `participants` (optional), `open_item` (boolean), `open_item_description` (optional), `resolves_event_id` (optional Ã¢ÂÂ marks an existing open item as resolved)
- Use case: Nathan says "I talked to Dave, the permit is approved" Ã¢ÂÂ agent logs the event and resolves any open item about the permit

**`get_open_items`**
- Input: `jobId` (optional Ã¢ÂÂ if omitted, returns all open items across all projects)
...
- Use case: Nathan says "The supplier got back to me on that" Ã¢ÂÂ agent resolves the specific open item
...
- **PENDING FOLLOW-UPS**: All open items across projects from `get_open_items()`, with age in days. AI incorporates these into the briefing: "You're still waiting on closet pricing from [supplier] for Oakes Ã¢ÂÂ sent 4 days ago, no reply yet."
...
- Suggested follow-up actions for overdue open items: "Follow up on Oakes closet pricing? (5 days, no reply)" Ã¢ÂÂ action creates a Gmail draft for review, NEVER auto-sends
...
- "Which projects have gone quiet?" Ã¢ÂÂ no events in 7+ days
- "What's stalled?" Ã¢ÂÂ open items unresolved for 5+ business days
- "What happened this week on Oakes?" Ã¢ÂÂ full event timeline
- "What did we decide about the kitchen layout?" Ã¢ÂÂ searches meeting transcripts and decision events
- "Give me a project summary for Oakes" Ã¢ÂÂ combines JT budget/schedule data with PML communication timeline
...
Resolution happens via ONE of:
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Gmail reply detected Ã¢ÂÂ auto_resolved: true (automatic)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Nathan tells agent "they called me back" Ã¢ÂÂ resolved: true (conversational)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Nathan clicks "Resolve" in dashboard Ã¢ÂÂ resolved: true (manual)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Nathan tells agent to dismiss Ã¢ÂÂ resolved: true, resolved_note: "dismissed"
  Ã¢ÂÂ
Item no longer appears in active open items
(Still queryable in project history with include_resolved: true)
```

**Critical rule:** Follow-up draft emails are SUGGESTED, never auto-sent. Nathan may have received the answer via phone, text, or in-person Ã¢ÂÂ channels the system cannot automatically verify. All follow-up actions require Nathan's approval.

### 15.7 Cron Jobs

| Cron | Schedule | Purpose |
|------|----------|---------|
| `gmail-to-pml` | Hourly during work hours (7am-9pm ET) | Sync inbox + sent mail Ã¢ÂÂ `project_events`, check for replies on open threads |
...
5. **Unmatched**: If no match found, store with `job_id: null` Ã¢ÂÂ still visible in the agent's global context, and Nathan can manually link it later via conversation ("that email about the tile was for Oakes")
...
Agent confirms project: "This looks like the Oakes meeting. Correct?"
  Ã¢ÂÂ
Claude processes transcript Ã¢ÂÂ extracts:
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ summary (2-3 sentences)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ key_decisions[] Ã¢ÂÂ each becomes a 'decision_made' event
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ action_items[] Ã¢ÂÂ offered as JT task creation (standard confirmation flow)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ commitments[] Ã¢ÂÂ logged as open items if follow-up needed
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ participants[] (extracted from transcript context)
  Ã¢ÂÂ
Creates project_events:
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ 1 primary event (channel: 'meeting', event_type: 'meeting_held', detail: full transcript)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ N decision events (related_event_id Ã¢ÂÂ primary)
  Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ M commitment events (open_item: true, related_event_id Ã¢ÂÂ primary)
```
...
|-------|------|-----------|------------|
| 1 | Supabase `project_events` table + `log_project_event` API endpoint | Foundation Ã¢ÂÂ enables manual event logging immediately via Ask Agent | Nothing |
...
| 3 | Meeting transcript processing in Know-it-All | Nathan is ready to paste from Plaud now Ã¢ÂÂ immediate value | Phase 1, 2 |
| 4 | Gmail sent mail sync Ã¢ÂÂ `project_events` + reply detection | Auto-captures outbound email context, biggest gap in current system | Phase 1 |
...
- Know-it-All's existing 39 tools stay Ã¢ÂÂ PML adds 4 new tools
- Dashboard briefing structure stays Ã¢ÂÂ gains richer context from PML
...
app/
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ api/
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ pml/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ route.ts                    # CRUD for project_events (GET list, POST create)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ [eventId]/route.ts          # GET/PATCH single event (resolve, update)
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ open-items/route.ts         # GET all unresolved open items
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ cron/
Ã¢ÂÂ   Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ gmail-to-pml/route.ts       # Hourly Gmail Ã¢ÂÂ project_events sync
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ sync/
Ã¢ÂÂ       Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ pml-backfill/route.ts       # One-time backfill of JT/text data into PML
Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ lib/
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ project-memory.ts               # PML service: queries, event creation, resolution, project matching
Ã¢ÂÂ   Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ gmail-sync.ts                   # Gmail sent+inbox sync, thread tracking, reply detection
```
...
- API: `GET /api/field-dashboard` — returns `{ greeting, tasks, activeJobs }`

#### Active Jobs with Expandable Schedules
- Lists all active jobs with search (by name, number, or client)
...
- API: `GET /api/field-job-schedule?jobId=...` — returns `{ phases: [{ name, progress, tasks }] }`
...
- **API**: `POST /api/field-schedule-task-update` — body: `{ taskId, completed?, endDate? }`
...
|---|---|---|
| `/api/field-dashboard` | GET | Tasks + active jobs for field user |
...
### 2026-03-28 — Field Staff Dashboard (Schedule Task Management)
...
### 2026-03-21 Ã¢ÂÂ Feature: Nathan's Brand Voice for AI Writing
...
**Files changed:**
- `app/lib/nathan-voice.ts` Ã¢ÂÂ **NEW** Condensed NATHAN_BRAND_VOICE constant for system prompts
- `app/lib/nathan-brand-voice.md` Ã¢ÂÂ **NEW** Full brand voice document (1375 lines)
- `app/api/dashboard/chat/route.ts` Ã¢ÂÂ Imports and injects NATHAN_BRAND_VOICE into chat system prompt
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Email draft voice rules added to suggestedActions prompt

### 2026-03-21 Ã¢ÂÂ Feature: Dashboard Chat Widget
...
**Files changed:**
- `app/api/dashboard/chat/route.ts` Ã¢ÂÂ **NEW** Chat endpoint with dashboard context + brand voice
- `app/dashboard/components/DashboardChat.tsx` Ã¢ÂÂ **NEW** Floating chat widget component
- `app/dashboard/page.tsx` Ã¢ÂÂ Added DashboardChat import and render

### 2026-03-21 Ã¢ÂÂ Feature: AI-Powered Inbox Cleanup + Auto-Archive
...
**Solution Ã¢ÂÂ Manual Cleanup:**
- "Clean Inbox" button on the dashboard Inbox section
- Click to scan Ã¢ÂÂ AI classifies each email as keep/archive Ã¢ÂÂ preview list Ã¢ÂÂ confirm to archive
...
**Solution Ã¢ÂÂ Automated Cleanup:**
...
**Files changed:**
- `app/lib/google-api.ts` Ã¢ÂÂ Added `archiveEmails()`, `fetchFullInbox()`, `createGmailDraft()`
- `app/api/dashboard/inbox-cleanup/route.ts` Ã¢ÂÂ **NEW** POST endpoint (preview + execute modes)
- `app/api/cron/inbox-cleanup/route.ts` Ã¢ÂÂ **NEW** Hourly cron for automated cleanup
- `app/api/dashboard/quick-action/route.ts` Ã¢ÂÂ **NEW** POST endpoint for Do Now actions (draft-email)
- `app/api/auth/google-callback/route.ts` Ã¢ÂÂ Upgraded scope to gmail.modify
- `app/dashboard/page.tsx` Ã¢ÂÂ Clean Inbox button, scanning/preview/cleaning states
- `vercel.json` Ã¢ÂÂ Added hourly inbox-cleanup cron

### 2026-03-21 Ã¢ÂÂ Feature: Do Now Email Drafts via Gmail API
...
**Solution:** Email actions now create real Gmail drafts via the API. Click a "Reply to..." button Ã¢ÂÂ API creates a draft with AI-written text Ã¢ÂÂ Gmail opens directly to that draft Ã¢ÂÂ review and send. Falls back to compose URL if draft creation fails.

**Files changed:**
- `app/lib/google-api.ts` Ã¢ÂÂ Added `createGmailDraft()` (RFC 2822 format, base64url encode)
- `app/api/dashboard/quick-action/route.ts` Ã¢ÂÂ **NEW** Handles draft-email action type
- `app/dashboard/page.tsx` Ã¢ÂÂ Updated action handler to call quick-action API for email drafts

### 2026-03-21 Ã¢ÂÂ Enhancement: Mobile Optimization
...
**Files changed:**
- `app/dashboard/page.tsx` Ã¢ÂÂ Responsive class updates throughout

### 2026-03-21 Ã¢ÂÂ Fix: Timezone Bug (Server UTC vs Eastern Time)
...
**Files changed:**
- `app/lib/dashboard-data.ts` Ã¢ÂÂ `getTimeContext()` rewritten with Eastern timezone
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ All date/time formatting uses `timeZone: 'America/New_York'`

### 2026-03-19 Ã¢ÂÂ Feature: Time-Aware Daily Operations Assistant + Tomorrow Preview
...
**Solution Ã¢ÂÂ Time-Aware Briefings:**
...
- AI prompt now includes time-period-specific instructions:
  - **Morning**: "First look at the day" Ã¢ÂÂ prioritizes today's calendar, urgent tasks, same-day email replies
  - **Midday**: "Quick status check" Ã¢ÂÂ focuses on what needs attention right now, new messages
  - **Evening**: "Tomorrow prep" Ã¢ÂÂ emphasizes tomorrow's schedule and what to prepare tonight
- Summary and action items adapt to the time period (evening actions say "prepare for tomorrow")

**Solution Ã¢ÂÂ Tomorrow Preview:**
...
**Solution Ã¢ÂÂ Time-Aware UI:**
- Header changes by time: "Good morning Ã¢ÂÂ Your day ahead" / "Afternoon check-in" / "Evening prep Ã¢ÂÂ Preparing for tomorrow"
...
**Files changed:**
- `app/lib/google-api.ts` Ã¢ÂÂ `fetchCalendarEvents()` now accepts custom start/end Date params for tomorrow-specific queries
- `app/lib/dashboard-data.ts` Ã¢ÂÂ Added `TimeContext` type, `getTimeContext()` function, `tomorrowTasks`, `tomorrowCalendarEvents`, `tasksTomorrow` and `tomorrowEventsCount` stats
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Added `TomorrowBriefing` interface, time-period-specific prompt instructions (morning/midday/evening), `tomorrowBriefing` in AI output with calendar walkthrough and prep actions, increased max_tokens to 3000
- `app/dashboard/page.tsx` Ã¢ÂÂ Time-aware header with `getSubGreeting()`, `TomorrowBriefing` interface, Tomorrow Preview section with schedule walkthrough and prep checklist, time context variables

### 2026-03-19 Ã¢ÂÂ Feature: Smart Quick Actions ("Do Now" Section)
...
**Solution Ã¢ÂÂ AI-Suggested Quick Actions:**
...
- AI generates `suggestedText` for email actions Ã¢ÂÂ 2-3 sentence professional drafts in BKB voice

**Solution Ã¢ÂÂ "Do Now" UI Section:**
...
- Clicking performs the action immediately Ã¢ÂÂ no confirmation for non-destructive actions

**Files changed:**
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Added `SuggestedAction` interface with actionType/context/priority, added to AI prompt with detailed instructions per action type, added to response parser and fallback
- `app/dashboard/page.tsx` Ã¢ÂÂ Added `SuggestedAction` interface, "Do Now" section with action handler logic (Gmail compose URLs, task completion, JT job navigation), priority indicators

### 2026-03-19 Ã¢ÂÂ Feature: Meeting Prep Notes, Deadline Alerts, Auto-Refresh
...
**Solution Ã¢ÂÂ Meeting Prep Notes:**
...
**Solution Ã¢ÂÂ Deadline Quick-Reschedule:**
...
**Solution Ã¢ÂÂ Auto-Refresh:**
- Dashboard auto-refreshes every 15 minutes during work hours (8am-6pm EST)
- Uses `setInterval` with hour check Ã¢ÂÂ no unnecessary API calls outside work hours
- Refresh runs silently in background without spinner (uses `fetchOverview(true)`)

**Files changed:**
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Added `MeetingPrepNote` interface, `meetingPrepNotes` to AI output and prompt rules, added to response parser and fallback
- `app/dashboard/page.tsx` Ã¢ÂÂ Calendar events now show AI prep notes as purple badges, overdue tasks show "+1d" quick-reschedule button, added 15-minute auto-refresh interval during work hours, added `MeetingPrepNote` and `activeJobs` to client-side types

### 2026-03-19 Ã¢ÂÂ Feature: Gmail Inbox + Google Calendar Integration for Dashboard
...
**Solution Ã¢ÂÂ Google Cloud OAuth Setup:**
...
**Solution Ã¢ÂÂ Google API Helper (`app/lib/google-api.ts`):**
...
**Solution Ã¢ÂÂ Dashboard Data Layer Updates:**
...
**Solution Ã¢ÂÂ AI Analysis Prompt Updates:**
...
**Files changed:**
- `app/lib/google-api.ts` Ã¢ÂÂ **NEW** Google OAuth2 helper with Gmail inbox and Calendar events fetchers
- `app/api/auth/google-callback/route.ts` Ã¢ÂÂ **NEW** OAuth callback endpoint for one-time token setup
- `app/lib/dashboard-data.ts` Ã¢ÂÂ Added Gmail + Calendar fetching, new calendarEvents field, updated stats
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Added CALENDAR section to AI prompt, improved email prompt

### 2026-03-19 Ã¢ÂÂ Feature: AI Description Rewriting for Cost-Plus Invoices

**Problem:** Cost-Plus invoices created via `createDraftCostPlusInvoice()` had raw, internal-facing descriptions Ã¢ÂÂ vendor sub-groups showed "Bill 1 - Vendor Name" and labor line items showed raw date breakdowns like "Mar 13: 2.0h". The Fixed-Price/Billable flow already had AI description rewriting, but Cost-Plus did not.

**Solution Ã¢ÂÂ AI Descriptions at Creation Time (`createDraftCostPlusInvoice`):**
...
All AI calls gracefully degrade Ã¢ÂÂ if Anthropic API fails, the invoice still creates with original/fallback descriptions.

**Solution Ã¢ÂÂ Reorganize Step Fix:**
...
- Renames "Vendor Bills" Ã¢ÂÂ "Trade Partners" or "Materials" based on cost code/type classification
...
1. Dashboard button Ã¢ÂÂ `POST /api/dashboard/invoicing/create-invoice` Ã¢ÂÂ creates invoice with AI descriptions on all groups and line items
2. Reorganize Ã¢ÂÂ `POST /api/dashboard/invoicing/reorganize-invoice` Ã¢ÂÂ renames Vendor Bills to Trade Partners/Materials, preserves AI descriptions

**Files changed:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added AI description rewriting to `createDraftCostPlusInvoice()`: vendor sub-groups (bill description lookup + Claude rewrite), BKB Labor group (time entry notes + Claude rewrite), worker labor line items (per-worker notes + Claude rewrite); added `notes` to time entry PAVE query; added `notes` to `TEInfo` type; fixed `Set` spread for TypeScript compatibility (`Array.from()`); added API-created invoice detection + light-touch reorganization path in `reorganizeCostPlusInvoice()`
- `ARCHITECTURE.md` Ã¢ÂÂ Updated project structure (added reorganize-invoice + queue-invoice routes), API endpoints table, changelog

### 2026-03-19 Ã¢ÂÂ Feature: Dashboard Overhaul Ã¢ÂÂ Per-User PIN Auth, Live Tasks, JT Comments, Task Actions

**Problem:** The dashboard had multiple fundamental issues:
1. No login page Ã¢ÂÂ navigating to `/dashboard` on a fresh browser showed infinite "Loading" because `useAuth()` returned no userId and there was no redirect to a login page
2. The single shared PIN (APP_PIN env var) meant nobody knew their PIN and there was no way to create one
3. Tasks showed 0 Ã¢ÂÂ two bugs: the org-level PAVE query capped at 100 results (oldest first, Nathan's tasks on newer jobs were excluded), and tasks with `progress: null` (unstarted schedule tasks) were excluded by the `progress < 1` filter
...
**Solution Ã¢ÂÂ Per-User PIN Authentication:**
- Created `/dashboard/login` page with 4-step flow: select user Ã¢ÂÂ enter PIN (if exists) Ã¢ÂÂ or create PIN (4+ digits) Ã¢ÂÂ confirm PIN
...
**Solution Ã¢ÂÂ Persistent Login:**
- Added `loading` state to `useAuth()` hook Ã¢ÂÂ initial state is `loading: true`
- Dashboard layout waits for `auth.loading` to be `false` before redirecting to login
- Token stored in `localStorage` persists across browser sessions Ã¢ÂÂ no re-login required

**Solution Ã¢ÂÂ Task Query Fix (12Ã¢ÂÂ14 tasks found):**
...
- Skips closed jobs entirely Ã¢ÂÂ only scans the ~49 active jobs
- Added `job.number` to task query for display

**Solution Ã¢ÂÂ Live JT Comments with Author Names:**
...
**Solution Ã¢ÂÂ AI Analysis Improvements:**
...
**Solution Ã¢ÂÂ Task Actions from Dashboard:**
- Added complete button (circle checkbox) on each task Ã¢ÂÂ click marks as done in JT (progress=1)
- Task fades out and removes from list immediately on completion
- Added clickable due date that opens inline date picker Ã¢ÂÂ updates both startDate and endDate in JT
...
| `PATCH /api/dashboard/tasks` | **NEW** Ã¢ÂÂ Complete tasks and update due dates |
| `GET /api/dashboard/overview` | Now returns live JT data with author names and all user tasks |

**Files changed:**
- `app/api/auth/route.ts` Ã¢ÂÂ Rewritten for per-user PIN auth with Supabase storage
- `app/api/lib/auth.ts` Ã¢ÂÂ Updated `validateAuth()` to accept per-user tokens
- `app/api/dashboard/tasks/route.ts` Ã¢ÂÂ Added PATCH handler for complete/update actions
- `app/dashboard/login/page.tsx` Ã¢ÂÂ **NEW** Per-user PIN login page with setup flow
- `app/dashboard/layout.tsx` Ã¢ÂÂ Added auth gate with loading state, login page bypass
- `app/dashboard/page.tsx` Ã¢ÂÂ Added task complete button, due date editor, `emailsNeedingReply` type
- `app/hooks/useAuth.ts` Ã¢ÂÂ Added `loading` state for persistent login
- `app/lib/dashboard-data.ts` Ã¢ÂÂ Rewritten: live PAVE comments, per-job task scan, Gmail/email data model
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ Rewritten: role-specific prompts for Nathan/Terri, daily log actionable-only, email section
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `getOpenTasksForMemberAcrossJobs()` (paginated per-job scan with null progress handling), exported `pave()`, increased `getAllOpenTasks` to 100 with null progress filter
- `ARCHITECTURE.md` Ã¢ÂÂ Added login page to project structure, full changelog entry

### 2026-03-18 Ã¢ÂÂ Feature: User Login with Team Selection + Personalized AI Dashboard
...
**Solution Ã¢ÂÂ User Login (Phase 1-3):**

1. **Token format**: Extended from `base64(pin:timestamp)` to `base64(pin:userId:timestamp)`. Backward compatible Ã¢ÂÂ old tokens still validate but return no userId. Updated all 11 API routes to use `validateAuth().valid` instead of boolean.
...
3. **TEAM_USERS config** (in `constants.ts`): Maps userId Ã¢ÂÂ name, initials, role, membershipId. Roles: Nathan (owner), Terri (admin), Evan (field_sup), Josh (field_sup), Dave (field).
...
**Solution Ã¢ÂÂ Personalized AI Dashboard (Phase 4):**
...
4. **Dashboard page** (`app/dashboard/page.tsx` Ã¢ÂÂ complete rewrite): Personalized greeting, 4 stat cards (Urgent, High Priority, Due Today, Open Tasks), AI Briefing panel, Needs Immediate Attention section, Action Items, Upcoming Deadlines, Messages to Review, Task list, Quick Actions (role-based nav links). Refresh button for fresh analysis.
...
- Dashboard page uses `useAuth()` for all personalization Ã¢ÂÂ no hardcoded values

**New files:**
- `app/hooks/useAuth.ts` Ã¢ÂÂ Client-side auth hook
- `app/lib/dashboard-data.ts` Ã¢ÂÂ Per-user data aggregation
- `app/lib/dashboard-analysis.ts` Ã¢ÂÂ AI analysis engine with role-specific prompts
- `app/api/dashboard/overview/route.ts` Ã¢ÂÂ Cached dashboard API endpoint

**Modified files:**
- `app/api/auth/route.ts` Ã¢ÂÂ Token includes userId
- `app/api/lib/auth.ts` Ã¢ÂÂ Returns `{ valid, userId }` instead of boolean
- `app/lib/constants.ts` Ã¢ÂÂ Added TEAM_USERS config
- `app/page.tsx` Ã¢ÂÂ Two-step login: PIN Ã¢ÂÂ user selection
- `app/dashboard/layout.tsx` Ã¢ÂÂ Dynamic user initials in avatar
- `app/dashboard/page.tsx` Ã¢ÂÂ Complete rewrite with AI-powered personalized dashboard
- 11 API routes Ã¢ÂÂ Updated `validateAuth()` call sites to use `.valid`

**Commits:** `2ef8f51`, `b45bdef`, `6b3ff74`

---

### 2026-03-18 Ã¢ÂÂ Fix: Time Entry Pagination for Jobs with >100 Entries
...
**Verified on Halvorsen Roof/Exterior (Job #154):** Page 1 returns 100 entries, page 2 returns 45 entries (total 145). All 18 CC23 entries now included, totaling 102.5 hours Ã¢ÂÂ matching JobTread UI exactly.

**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Rewrote `getTimeEntriesForJob()`: paginated fetch loop using `["id", ">", lastId]` cursor, safety cap of 10 pages, falls back to org-level query on failure
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Removed explicit `100` limit arg (uses default with pagination)

---

### 2026-03-18 Ã¢ÂÂ Enhancement: Fixed-Price Invoice Template, Custom Field Pricing, QTY Hidden
...
**Solution:**
1. **Company info**: Sets `fromAddress` ("7843 Richlandtown Rd, Quakertown, PA 18951, USA") and `fromOrganizationName` ("Brett King Builder-Contractor Inc.") via `updateDocument` after creation. Phone/email fields don't exist on PAVE documents Ã¢ÂÂ they come from the JT template when created through the UI.
...
3. **Custom field pricing**: Reads job custom fields "Margin" (ID: `22PAE53xn6XJ`) and "Hourly Rate" (ID: `22PAE4yybHpg`) from the job's `customFieldValues`. Materials/subs use `cost ÃÂ (1 + margin/100)` for pricing (e.g., 30% margin = 1.30ÃÂ multiplier). Labor uses the hourly rate directly as `unitPrice`. Defaults if fields not set: 25% margin, $115/hr.

4. **Renamed group**: "Trade Partners" Ã¢ÂÂ "Billable Items" for Fixed-Price invoices (Cost-Plus still uses "Trade Partners")
...
The FIFO deduction system handles this automatically. Each time "Create Billable Invoice" is run, it compares CC23 vendor bill costs against CC23 customer invoice costs per budget item. Items already on approved/pending invoices are deducted. Draft invoices are filtered out (`status !== 'draft'`), so creating and deleting drafts has no effect on the tracking. Source bill references are embedded in each line item's description (hidden from client via `showChildren: false`, visible to team when expanding) Ã¢ÂÂ e.g., "Source: Bill 187-14 | 01-Gen Supplies, Admin Costs."

**Verified on Sines Add Powder Room (Job #187, Margin=30%, Hourly Rate=$125):**
- Doylestown Borough Bill: $254.50 ÃÂ 1.30 = $330.85 Ã¢ÂÂ
- Middle Department Inspection: $100 ÃÂ 1.30 = $130.00 Ã¢ÂÂ
- BKB Labor: 2h ÃÂ $125 = $250.00 Ã¢ÂÂ
- Total: $710.85 Ã¢ÂÂ
- Company address populated, QTY hidden, "Billable Items" group name Ã¢ÂÂ
- After draft deletion, numbers return to $354.50 + 2h Ã¢ÂÂ

**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Updated `createDraftBillableInvoice()`: reads Margin/Hourly Rate custom fields, sets fromAddress/fromOrganizationName/showQuantity via updateDocument, renamed group to "Billable Items", margin-based pricing for materials/subs, hourly rate for labor

**Commits:** `8ef842f`

---

### 2026-03-18 Ã¢ÂÂ Feature: Fixed-Price Billable Invoice with BKB 3-Group Format

**Problem:** The Fixed-Price "Create Billable Invoice" button had two issues: (1) it used budget-item-ID presence to determine what's been invoiced (same bug as the old Cost-Plus code Ã¢ÂÂ fails when multiple vendor bill items share a budget ID), and (2) it created invoices with a flat structure instead of the BKB 3-group format with AI descriptions.

**Solution Ã¢ÂÂ FIFO deduction fix:** Replaced the `billedBudgetItemIds` Set-based filter with per-budget-item FIFO deduction (same approach as Cost-Plus). Groups CC23 vendor bill costs by budget item, deducts invoiced amounts from oldest items first, includes items not fully covered.

**Solution Ã¢ÂÂ 3-group format:** Rewrote the invoice creation to use the same Trade Partners / Materials / BKB Labor structure as Cost-Plus:
...
**Pricing fix:** Vendor bill items have `unitPrice: 0` (bills don't have sell prices). Now falls back to `cost ÃÂ 1.25` markup when unitPrice is missing.

**AI prompt fix:** Category-level AI description prompts were too open-ended Ã¢ÂÂ Claude sometimes returned conversational text instead of bullet points. Updated prompts to explicitly say "Output ONLY the bullet points, nothing else."
...
**Draft deletion tracking:** Confirmed working Ã¢ÂÂ the analysis filters customer invoices with `status !== 'draft'`, so drafts never affect unbilled calculations. Creating and deleting a draft leaves the numbers unchanged.

**Verified on Sines Add Powder Room (Job #187):**
- Dashboard: Billable $354.50 + Labor 2h (matches JT)
- Draft Invoice 71: 3 items totaling $673.13 (bills with 25% markup + 2h ÃÂ $115)
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Rewrote `createDraftBillableInvoice()`: FIFO deduction for CC23 items, BKB 3-group format with AI descriptions, 25% markup on bills, bill references in line items, `showChildren: false`, fixed AI prompts for all description generation

**Commits:** `576ccd8`, `4508e7d`

---

### 2026-03-17 Ã¢ÂÂ Feature: Invoice Reorganization into BKB 3-Group Format with AI Descriptions

**Problem:** Invoices created through JT's Bills & Time UI have a flat structure Ã¢ÂÂ all vendor bill groups and time cost groups are at the top level with no categorization. Descriptions default to generic bill subjects like "Edwards - ongoing". The Behmlander Invoice 199-15 established the BKB standard: three parent categories with bullet-point descriptions, vendor bills grouped under Trade Partners or Materials, and labor under BKB Labor with work descriptions from time entry notes.
...
1. **Trade Partners** Ã¢ÂÂ subcontractor and admin vendor bills (cost codes 1, 18, 20-23)
...
2. **Materials** Ã¢ÂÂ material vendor bills (cost type "Materials")
...
3. **BKB Labor** Ã¢ÂÂ all time entry groups
...
- Bill descriptions fetched by matching group name bill numbers to vendor bill documents (required `String(d.number)` coercion Ã¢ÂÂ PAVE returns numbers as number type, not string)
- AI rewriting uses Claude Sonnet via Anthropic API for both category-level and bill-level descriptions
- Function is idempotent Ã¢ÂÂ deletes existing category groups before recreating (safe to run twice)
- JT Bills & Time creates ALL groups flat at the top level (no nesting) Ã¢ÂÂ function re-parents them under new category groups using `updateCostGroup` with `parentCostGroupId`

**API endpoint:** `POST /api/dashboard/invoicing/reorganize-invoice` Ã¢ÂÂ takes `{ documentId, jobId }`, calls `reorganizeCostPlusInvoice()`, returns success with descriptions

**Full invoice creation flow:**
1. Dashboard button Ã¢ÂÂ queues request in Supabase
2. Scheduled task Ã¢ÂÂ creates invoice through JT Bills & Time UI (Chrome automation)
3. Reorganize API Ã¢ÂÂ restructures into 3 categories, hides line items, AI-rewrites all descriptions
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `reorganizeCostPlusInvoice()`, `deleteJTCostGroup()`, `updateJTCostGroup()` helper functions; bill description fetching + AI rewriting per sub-group; `showChildren: false` on all sub-groups; idempotency (deletes old category groups); `String()` coercion for bill number matching
- `app/api/dashboard/invoicing/reorganize-invoice/route.ts` Ã¢ÂÂ **NEW** POST endpoint (maxDuration=60)

**Commits:** `446947d`, `a687a8f`, `448940a`, `1ed3045`, `6ced968`, `4ab0ba0`

---

### 2026-03-17 Ã¢ÂÂ Feature: Queue-Based Invoice Creation via JT Bills & Time UI

**Problem:** When invoices are created via the PAVE API (createDocument + createCostItem), JT's native "Not Invoiced" tracking in the Bills and Time tab doesn't update Ã¢ÂÂ bills and time entries still show as uninvoiced. Only invoices created through JT's own UI Bills & Time flow properly mark items as invoiced (even in draft status). Exhaustive testing confirmed there is no PAVE API method to replicate this linkage Ã¢ÂÂ `sourceCostItemId` on createCostItem is accepted but doesn't persist, `updateCostItem` rejects it as "invalid", and no document-level or time-entry-level linkage fields exist.
...
1. **Dashboard button** Ã¢ÂÂ writes a request to Supabase `invoice_creation_requests` table (with duplicate detection)
2. **Claude scheduled task** ("create-jt-invoice") Ã¢ÂÂ reads pending requests from Supabase, opens Chrome to JT, navigates through + Document Ã¢ÂÂ Invoice Ã¢ÂÂ Bills and Time Ã¢ÂÂ Select All Ã¢ÂÂ Create
3. **JT marks items as invoiced** because the invoice was created through the native UI flow

**Supabase table:** `invoice_creation_requests` Ã¢ÂÂ columns: id (UUID), job_id, job_name, job_number, client_name, status (pending/processing/completed/failed), invoice_number, invoice_id, error, created_at, updated_at, completed_at

**Changes:**
- `app/api/dashboard/invoicing/queue-invoice/route.ts` Ã¢ÂÂ **NEW** POST endpoint that inserts into `invoice_creation_requests` with duplicate detection for pending/processing requests
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Changed `CostPlusJobCard` button handler from direct PAVE call (`/api/dashboard/invoicing/create-invoice`) to queue call (`/api/dashboard/invoicing/queue-invoice`); updated success message to instruct user to run the scheduled task

**Scheduled task:** `create-jt-invoice` (on-demand, no cron) Ã¢ÂÂ reads pending requests from Supabase REST API, processes each via Chrome browser automation through JT's Bills & Time flow, updates Supabase with result. Located at `~/Documents/Claude/Scheduled/create-jt-invoice/SKILL.md`.

**Verified on Edwards Ongoing (Job #170):** Dashboard button queued request Ã¢ÂÂ scheduled task created Invoice 170-23 through JT UI Ã¢ÂÂ Bills & Time "Not Invoiced" list cleared to empty Ã¢ÂÂ Supabase request marked as completed.

**Key finding Ã¢ÂÂ PAVE API has NO Bills & Time linkage support:**
...
**Solution Ã¢ÂÂ Analysis (`analyzeCostPlusJob`):**
...
**Solution Ã¢ÂÂ Invoice Creation (`createDraftCostPlusInvoice`):**
...
- Dashboard unbilled costs: $808.66 Ã¢ÂÂ exact match with JT "Not Invoiced" view (Olde Town $270 + Wehrung's $24.56 + Reeds $514.10)
...
**Key Architectural Lesson Ã¢ÂÂ Per-Budget-Item FIFO Deduction:**
...
**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Rewrote `analyzeCostPlusJob()`: removed `getDocumentCostItemsForJob` call, added per-document vendor bill fetching via `getDocumentCostItemsById`, implemented FIFO deduction for both bills and time entries
- `app/lib/jobtread.ts` Ã¢ÂÂ Rewrote `createDraftCostPlusInvoice()`: pulls from uninvoiced vendor bills and time entries instead of budget items; added `jobCostItem: { id: {} }` to `getDocumentCostItemsById` query; added `cost` field to time entry PAVE query and `JTTimeEntry` interface; fixed PAVE query size limit (200 Ã¢ÂÂ 100)

**Commits:** `3e6dc4c`, `235bbec`

---

### 2026-03-17 Ã¢ÂÂ Feature: One-Click Billable Invoice for Fixed-Price Contract Jobs
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `createDraftBillableInvoice()` function (~250 lines). Queries vendor bill CC23 items, customer invoice CC23 items, matches by jobCostItemId, fetches CC23 time entries, creates document shell + groups (Materials & Subs Ã¢ÂÂ Labor) + items
- `app/api/dashboard/invoicing/create-billable-invoice/route.ts` Ã¢ÂÂ **NEW** POST endpoint for fixed-price billable invoice creation
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added state, handler, and button UI to `ContractJobCard` (mirrors CostPlusJobCard pattern)

### 2026-03-17 Ã¢ÂÂ Revert: Cost-Plus Unbilled Hours (Count All, Not Just CC23)

**Problem:** Incorrectly changed `analyzeCostPlusJob()` to only count CC23 time entries (commit `4d92522`). This broke Cost-Plus reporting Ã¢ÂÂ Silver Maintenance dropped from 18.3h to 10.3h.
...
### 2026-03-17 Ã¢ÂÂ Enhancement: Invoice Group Ordering + Material Descriptions
...
**Solution:** Added explicit `categoryOrder` array: materials Ã¢ÂÂ admin Ã¢ÂÂ subcontractor Ã¢ÂÂ other Ã¢ÂÂ labor. Added `buildItemDescription()` helper that generates descriptions from cost code info (e.g., "03-Concrete, Stone/Block Work") for material items.

**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `categoryOrder`, `categoryNames`, `buildItemDescription()` in `createDraftCostPlusInvoice()`

### 2026-03-17 Ã¢ÂÂ Enhancement: Exclude $0.00 Placeholder Items from Cost-Plus Invoices
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added zero-value filter at line ~2952 in `createDraftCostPlusInvoice()`

### 2026-03-16 Ã¢ÂÂ Feature: One-Click Draft Invoice for Cost-Plus Jobs
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `createDraftCostPlusInvoice()`, `createJTDocument()`, `createJTCostGroup()`, `createJTCostItem()` PAVE mutation functions
- `app/api/dashboard/invoicing/create-invoice/route.ts` Ã¢ÂÂ **NEW** POST endpoint (maxDuration=60)
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added state, handler, and button UI to `CostPlusJobCard`

**Tested:** Edwards Ongoing (Invoice 170-13, 66 items, $3,784.15) Ã¢ÂÂ created and cleaned up successfully.

### 2026-03-16 Ã¢ÂÂ Fix: Labor Hours Deduction (Name vs CostType)
...
**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Changed `cc23LaborOnInvoices` filter from `costType?.name === 'Labor'` to `name?.toLowerCase().includes('labor')`

**Commits:** `c45971a`

---

### 2026-03-16 Ã¢ÂÂ Fix: CostCode + CostType Filter for Fixed-Price Billable Items
...
- **Labor hours:** Kept separate Ã¢ÂÂ uses name-based filter (see commit `c45971a`)
- Cost-Plus jobs and `findBillableItems()` still use the old name prefix filter

**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `costType: { id: {}, name: {} }` to `getDocumentCostItemsById` PAVE query
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Added `BILLABLE_COST_TYPE_NAMES` constant; rewrote `analyzeContractJob()` billable cost calculation to use costCode + costType filter; separated `allCC23` (all CC23 items) from `cc23Billable` (Materials/Subcontractor only)

**Commits:** `b04f7ee`

---

### 2026-03-16 Ã¢ÂÂ Fix: Exclude Denied (Deleted) Vendor Bills from Dashboard
...
1. `analyzeContractJob()` Ã¢ÂÂ vendor bill selection for CC23 cost analysis
2. `analyzeCostPlusJob()` Ã¢ÂÂ builds a set of denied bill IDs, excludes their cost items
3. `buildInvoicingContext()` Ã¢ÂÂ pre-filters cost items before passing to `findBillableItems()`

**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Added denied bill filtering in `analyzeContractJob()`, `analyzeCostPlusJob()`, and `buildInvoicingContext()`

**Commits:** `939ec82`

---

### 2026-03-16 Ã¢ÂÂ Fix: Filter Unselected Document Options from Specs Agent

**Problem:** The Specs agent was returning results for cost items that belonged to unselected document options. In JobTread, documents (estimates/contracts) can have multiple option groups (e.g., two flooring choices), and the client selects which ones they want. The agent was showing ALL options regardless of selection status Ã¢ÂÂ e.g., "Sterling Quartzite (AKT-LM51)" appeared in results even though only "Alpine Quartzite (AKT-LM50)" was selected.
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `isSelected: {}` to both cost items and cost groups in the `getDocumentCostItemsLightById()` PAVE query; preserved `isSelected` in the mapped return objects
- `app/api/lib/agents/project-details.ts` Ã¢ÂÂ After fetching document items, builds `unselectedItemIds` set from items where `isSelected === false`; filters budget items to exclude unselected IDs; skips unselected items when processing document-level items

**Commits:** `0b8a64e`

---

### 2026-03-15 Ã¢ÂÂ Fix: Specs Agent File Links (CDN URLs)
...
**Solution:** Changed file link generation to be server-side rather than AI-generated. File URLs now use the stable CDN pattern `https://cdn.jobtread.com/files/{fileId}` with real file IDs from the PAVE API, appended in the context string that gets passed to Claude. This prevents hallucination since the AI never constructs file URLs Ã¢ÂÂ it only references pre-built links.

**Changes:**
- `app/api/lib/agents/project-details.ts` Ã¢ÂÂ Modified context builder to append CDN-based file links using actual file IDs from cost items, cost groups, and parent cost groups; updated system prompt to instruct Claude to use file links from the provided data rather than constructing them

**Commits:** `9ee8d33`

---

### 2026-03-13 Ã¢ÂÂ Feature: Unpaid Invoice Total on Project Cards
...
**Solution:** Added an inline "Ã¢ÂÂ¢ $X,XXX unpaid" indicator in yellow (`#eab308`) to the subtitle row of both Contract and Cost Plus cards. Only appears when open (pending) invoices exist Ã¢ÂÂ keeps cards clean when everything is paid.

**Implementation:** Computes `unpaidTotal` from `releasedInvoices.filter(status === 'open')` at render time in both card components.

**Changes:**
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added `unpaidTotal` calculation and conditional display to both `ContractJobCard` and `CostPlusJobCard`

**Commits:** `6646b67`

---

### 2026-03-12 Ã¢ÂÂ Feature: Collapsible Invoice Details (Draft + Paid + Open)
...
- In `analyzeContractJob()`: builds `releasedInvoiceInfos` from approved (Ã¢ÂÂpaid) and pending (Ã¢ÂÂopen) customer invoices
...
**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Added `ReleasedInvoiceInfo` interface, `releasedInvoices` to both job health interfaces, populated in both analyzer functions
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added `ReleasedInvoiceInfo` interface, updated both job health interfaces, new `InvoiceDetails` component, replaced `DraftInvoicesList` usage

**Commits:** `7265a64`

---

### 2026-03-12 Ã¢ÂÂ Feature: Collapsible Draft Invoice List + Create $ Task Button
...
1. `DraftInvoicesList` Ã¢ÂÂ collapsible list showing each draft invoice with name and amount
2. `CreateTaskRow` Ã¢ÂÂ inline button on unmatched draft invoices that calls `/api/dashboard/invoicing/create-task` to create a `$` schedule task in JobTread. Shows loading/success/error states. Includes duplicate detection.

**Changes:**
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added `DraftInvoicesList` and `CreateTaskRow` components, added to `ContractJobCard`
- `app/api/dashboard/invoicing/create-task/route.ts` Ã¢ÂÂ **NEW** API endpoint for creating `$` schedule tasks from draft invoices

---

### 2026-03-12 Ã¢ÂÂ Fix: Contract Job Billable Costs & Labor Hours (413 Error Recovery)
...
1. **Billable labor hours** Ã¢ÂÂ The dashboard was counting ALL time entries, but contract jobs need to count only entries with `type === 'Billable'` (not `type === 'Standard'`). Standard hours are part of the contract; Billable hours need separate invoicing.

2. **Billable costs ($0)** Ã¢ÂÂ The `getCostItemsForJobLite()` function returns **budget-level** cost items only. CC23 costs on vendor bills (e.g., $254.50 + $100.00 = $354.50 on the Sines project) are **document-level** cost items that don't appear in `job.costItems`. A new approach was needed to fetch document-level items.

**Failed approaches (important for future reference):**
- Ã¢ÂÂ **Attempt 1** (`a661920`): Changed to "vendor bill costs minus invoice costs" using budget-level `costItems` Ã¢ÂÂ still $0 because vendor bill line items aren't in `job.costItems`
- Ã¢ÂÂ **Attempt 2** (`0307e88`): Created `getDocumentCostItemsForJob()` with nested query `job.documents.costItems` (50 docs ÃÂ 50 items) Ã¢ÂÂ caused **413 Request Entity Too Large** errors. Since this was inside `Promise.all` with the other 3 API calls, ALL parallel calls failed, returning empty arrays. This broke the ENTIRE dashboard (all jobs showed zeros for everything).
...
- Added `getDocumentCostItemsById(documentId)` Ã¢ÂÂ fetches cost items for a single document (tiny query, no 413 risk)
...
**Key architectural lesson Ã¢ÂÂ Budget-level vs Document-level cost items:**
...
- NEVER use a nested `job.documents.costItems` bulk query Ã¢ÂÂ it causes 413 errors
...
**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `getDocumentCostItemsById()` function for per-document cost item queries
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Removed `getDocumentCostItemsForJob` from imports and main batch fetch; reverted to 3 parallel calls; updated `analyzeContractJob()` to fetch CC23 document cost items internally per-document; labor hours now filter by `type === 'Billable'`

**Commits:** `1172770` Ã¢ÂÂ `a661920` Ã¢ÂÂ `0307e88` (broken) Ã¢ÂÂ `bd452c7` (final fix)

---

### 2026-03-12 Ã¢ÂÂ UI: Health-Priority Sorting, Condensed Cards, Search
...
1. **Health-priority sorting** Ã¢ÂÂ Jobs now sort by health severity (critical Ã¢ÂÂ overdue Ã¢ÂÂ warning Ã¢ÂÂ healthy) instead of status category. Removed `groupJobsByStatus()` sub-section grouping and `SubSectionHeader` component. Added `HEALTH_PRIORITY` lookup and `sortByHealthPriority()` helper.

2. **Condensed job cards** Ã¢ÂÂ Both `ContractJobCard` and `CostPlusJobCard` redesigned with:
   - Reduced padding (`p-4` Ã¢ÂÂ `px-3 py-2.5`)
   - Inline stats row instead of 3-column grid
   - Thinner progress bars (`h-2` Ã¢ÂÂ `h-1.5`)
   - Alert rows condensed to single-line `text-[11px]` with inline icons
   - Removed nested background boxes for stats

3. **Search box** Ã¢ÂÂ Added a search input that filters all three sections (contract, cost-plus, billable items) by job name, number, or client name. Real-time filtering with clear button.

**Files changed:**
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ All three changes above
- `ARCHITECTURE.md` Ã¢ÂÂ Updated changelog

---

### 2026-03-12 Ã¢ÂÂ Revision: Invoicing Health Threshold Overhaul

**Problem:** The original invoicing health thresholds were too simplistic. Contract (Fixed-Price) jobs only tracked milestone due dates and draft invoices Ã¢ÂÂ they had no visibility into billable items (Cost Code 23) or billable labor hours accumulating without being invoiced. Draft invoices alone were triggering Warning status, which was noise. Cost-Plus jobs flagged "no invoices ever sent" as a Warning, which wasn't useful for new jobs. Additionally, there was no early warning when a payment milestone was approaching.

**Solution:** Comprehensive threshold revision for both Contract and Cost-Plus job types.

**Contract (Fixed-Price) Ã¢ÂÂ New Thresholds:**
...
| `$` milestone task 1Ã¢ÂÂ14 days past due | Overdue |
| `$` milestone task 14+ days past due | Critical |

**Contract Ã¢ÂÂ What Changed:**
- **Removed:** Draft invoices alone no longer trigger Warning
- **Added:** Draft invoice with no matching `$` schedule task Ã¢ÂÂ Warning (name-based fuzzy matching between draft invoice name and `$` task name minus the `$` prefix)
- **Added:** `$` milestone approaching (due within 2 days) Ã¢ÂÂ Warning
- **Added:** Billable items (Cost Code 23 cost items not on a document) Ã¢ÂÂ Warning at $200, Overdue at $800
- **Added:** Billable labor (time entries linked to Cost Code 23 items) Ã¢ÂÂ Warning at 1 hr, Overdue at 3 hrs
...
1. Core data layer (`invoicing-health.ts`) Ã¢ÂÂ queries JT for all active jobs, classifies them by Price Type (Fixed-Price vs Cost-Plus), analyzes invoicing health for each profile
2. Dashboard API (`/api/dashboard/invoicing`) Ã¢ÂÂ serves cached or fresh invoicing health data with Supabase caching
3. Dashboard UI (`/dashboard/invoicing/page.tsx`) Ã¢ÂÂ summary cards, contract job progress, cost-plus billing cadence indicators, billable items panel with expand/collapse
4. Agent analysis endpoint (`/api/agent/invoicing`) Ã¢ÂÂ runs Claude analysis on invoicing data, generates prioritized recommendations
5. Daily cron job (`/api/cron/invoicing-health`) Ã¢ÂÂ runs at 1 AM EST to refresh cached data
...
- Health levels: healthy Ã¢ÂÂ warning Ã¢ÂÂ overdue Ã¢ÂÂ critical

**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ **NEW** Core invoicing health analysis logic
- `app/api/dashboard/invoicing/route.ts` Ã¢ÂÂ **NEW** Dashboard data endpoint with Supabase caching
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ **NEW** Invoicing health dashboard UI
- `app/api/agent/invoicing/route.ts` Ã¢ÂÂ **NEW** Claude-powered agent analysis endpoint
- `app/api/cron/invoicing-health/route.ts` Ã¢ÂÂ **NEW** Daily 1 AM cron job
- `app/dashboard/layout.tsx` Ã¢ÂÂ Added "Invoicing" nav item with DollarSign icon
- `vercel.json` Ã¢ÂÂ Added invoicing-health cron schedule (0 6 * * * = 1 AM EST)
- `BUILD_PLAN_INVOICING_HEALTH.md` Ã¢ÂÂ **NEW** Build plan document for session continuity
- `ARCHITECTURE.md` Ã¢ÂÂ Updated changelog

### 2026-03-11 Ã¢ÂÂ Fix: Use Native priceType Field for Job Classification

**Problem:** The invoicing dashboard was misclassifying most jobs as Cost-Plus when they were actually Fixed-Price. The original heuristic checked for "Billing Items Pending" cost groups and vendor bills to determine price type Ã¢ÂÂ this was unreliable and got the majority of jobs wrong (only ~3 Fixed-Price vs ~47 Cost-Plus, when the real split is ~27/23).

**Root Cause:** JobTread has a native `priceType` field on the job entity (values: `"fixed"` or `"costPlus"`) that was not being queried. This field is NOT a custom field Ã¢ÂÂ it's a first-class PAVE API field available on every job.

**Solution:** Replaced the ~100-line heuristic with a simple mapping of the native `priceType` field.

**Changes:**
- `app/lib/jobtread.ts` Ã¢ÂÂ Added `priceType?: string | null` to `JTJob` interface, added `priceType: {}` to the PAVE query in `getActiveJobs()`, mapped `priceType` in return object
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Replaced heuristic classification block with native priceType mapping (`"fixed"` Ã¢ÂÂ Fixed-Price, `"costPlus"` Ã¢ÂÂ Cost-Plus), removed ~100 lines of dead heuristic code and unused `getJobPriceType()` function

**Commits:** `e30244a`

### 2026-03-11 Ã¢ÂÂ Feature: Group Jobs by Status Category with Collapsible Sections
...
**Changes:**
- `app/lib/invoicing-health.ts` Ã¢ÂÂ Added `customStatus: string | null` to `ContractJobHealth`, `CostPlusJobHealth`, and `BillableItemsSummary` interfaces; populated from `job.customStatus` in all three analysis functions
- `app/dashboard/invoicing/page.tsx` Ã¢ÂÂ Added `STATUS_CATEGORIES` constant, `getStatusCategory()` and `groupJobsByStatus()` helpers, `SubSectionHeader` component, sub-section expand/collapse state management; replaced flat job grids with grouped collapsible views in both Contract and Cost-Plus sections

**Commits:** `fb284b3`

### 2026-03-10 Ã¢ÂÂ Session: GHL Ã¢ÂÂ JobTread Meeting Sync
...
1. New `syncGHLMeetingsToJT()` function in GHL service layer Ã¢ÂÂ pulls GHL appointments, maps contacts to active JT jobs by client name, creates JT tasks for new meetings (with duplicate detection)
2. Added Phase 3 to daily cron sync (5 AM) Ã¢ÂÂ automatically syncs GHL meetings to JT each morning
3. New `sync_ghl_meetings_to_jt` agent tool Ã¢ÂÂ allows on-demand sync from the Ask Agent ("sync my meetings to JobTread")
4. Synced tasks are prefixed with Ã°ÂÂÂ and include meeting details (time, contact, notes) in the description

**Changes:**
- `app/lib/ghl.ts` Ã¢ÂÂ Added `syncGHLMeetingsToJT()` with contactÃ¢ÂÂjob mapping, duplicate detection, and dry-run support
- `app/api/cron/sync-incremental/route.ts` Ã¢ÂÂ Added Phase 3 for GHL meeting sync after existing message/note sync
- `app/api/lib/agents/know-it-all.ts` Ã¢ÂÂ Added `sync_ghl_meetings_to_jt` tool definition and handler, updated system prompt with sync info, expanded canHandle() for sync queries
- `ARCHITECTURE.md` Ã¢ÂÂ Updated changelog

### 2026-03-10 Ã¢ÂÂ Session: Add GHL Calendar Access to Ask Agent
...
**Changes:**
- `app/lib/ghl.ts` Ã¢ÂÂ Added `getCalendars()`, `getAppointment()`, and `createAppointment()` functions to GHL service layer
- `app/api/lib/agents/know-it-all.ts` Ã¢ÂÂ Added GHL calendar imports, 2 new tool definitions (`get_ghl_calendar`, `get_ghl_calendars_list`), tool execution handlers, SCHEDULE & CALENDAR section in system prompt, canHandle() boost for meeting/appointment queries
- `ARCHITECTURE.md` Ã¢ÂÂ Updated changelog

### 2026-03-10 Ã¢ÂÂ Session: Fix Ask Agent Verbosity + Tool Loop Exhaustion
...
3. Tightened `needsConfirmation` regex to only match explicit "shall/should I proceed?" patterns, not casual offers Ã¢ÂÂ the `@@TASK_CONFIRM@@` flow already handles structured confirmations separately

**Changes:**
- `app/api/lib/agents/know-it-all.ts` Ã¢ÂÂ Added RESPONSE STYLE section to system prompt: direct answers for reads, concise 2-4 sentence lookups, no "Would you like me to..." on simple queries
- `app/api/lib/agents/router.ts` Ã¢ÂÂ Increased `iterations < 3` to `iterations < 5`; tightened `needsConfirmation` regex to avoid false positives from casual suggestions

### 2026-03-07 Ã¢ÂÂ Session: Merge JT Entry into Know-it-All (Unified Ask Agent)
...
**Changes:**
- `app/api/lib/agents/know-it-all.ts` Ã¢ÂÂ Added all 20 write imports, 16 write tool definitions, 16 write executeTool handlers, comprehensive system prompt with task confirmation format + phase assignment rules + field mapping, updated canHandle() with write operation patterns
- `app/api/lib/agents/router.ts` Ã¢ÂÂ Removed jt-entry import and registration, simplified forcedAgent routing
- `ARCHITECTURE.md` Ã¢ÂÂ Updated agent table, routing docs, gotchas, project structure to reflect merge

**Commits:** `04758ec` (agent merge), next commit (architecture doc update)

### 2026-03-07 Ã¢ÂÂ Session: Fix Orphan Tasks + Date/Assignee Passthrough

**Problem 1:** When user edited the phase in the confirmation card dropdown, the stale `phaseId` from the original suggestion was still sent. Claude used the old phaseId, creating the task under the wrong phase Ã¢ÂÂ or as an orphan with no phase at all.
...
**Changes:**
- `app/hooks/useAskAgent.ts` Ã¢ÂÂ When user changes phase in dropdown, delete stale `phaseId` and set `phaseChanged: true` so Claude is forced to look up the correct phase ID via `get_job_schedule`
- `app/api/lib/agents/jt-entry.ts` Ã¢ÂÂ Added `startDate` and `endDate` to `create_phase_task` tool schema; updated execution code to pass them to `createPhaseTask()`; added explicit field mapping instructions and phase change handling steps to system prompt
...
### 2026-03-07 Ã¢ÂÂ Session: Fix Task Confirmation Card
...
**Changes:**
- Fixed `app/api/chat/route.ts` Ã¢ÂÂ `needsConfirmation` now set to `true` when `taskConfirm` is parsed (`!!taskConfirm`)
- Added `TaskConfirmData` type to `app/hooks/useAskAgent.ts` + store `data.taskConfirm` in ChatMessage
- Added `TaskConfirmCard` component to `app/dashboard/ask/page.tsx` (desktop) Ã¢ÂÂ renders name, phase, assignee, dates, description
- Added `TaskConfirmCard` component to `app/m/ask/page.tsx` (mobile) Ã¢ÂÂ same data, mobile-optimized layout

**Commit:** `9d85940`

### 2026-03-06 Ã¢ÂÂ Session: Mobile Ask Agent + Shared Hook

**Changes:**
- Created `app/hooks/useAskAgent.ts` Ã¢ÂÂ shared hook for all Ask Agent logic
- Refactored `app/dashboard/ask/page.tsx` to use shared hook (6.95 KB Ã¢ÂÂ 4.76 KB)
- Created `app/m/ask/page.tsx` Ã¢ÂÂ mobile-friendly Ask Agent at `/m/ask`
- Created `app/m/layout.tsx` Ã¢ÂÂ minimal mobile layout (no dashboard chrome)
- Created `ARCHITECTURE.md` Ã¢ÂÂ this document

**Commits:** `fe2f195`, `1d04da3`

### 2026-03-06 Ã¢ÂÂ Session: Spec Writer PDF Fix

**Changes:**
- Fixed `app/dashboard/spec-writer/page.tsx` Ã¢ÂÂ added PDF extraction to file upload (was only reading text files, PDFs had no content)
- Updated `app/api/spec-writer/generate/route.ts` Ã¢ÂÂ added Vendor Estimate / Material Specification Mode to system prompt, increased file content cap 10K Ã¢ÂÂ 30K
- Updated `app/api/lib/agents/know-it-all.ts` Ã¢ÂÂ added material spec writing instructions + routing boost (0.92 for spec keywords)
- Updated `app/api/lib/agents/jt-entry.ts` Ã¢ÂÂ added spec writing exclusion rule (0.05 for spec keywords)

**Commits:** `ac97775`, `ba72352`

### 2026-03-06 Ã¢ÂÂ Session: Earlier fixes (from prior compacted session)
...
- Critical bug fix Ã¢ÂÂ confirmations routed to wrong agent (`3e982ac`)
...
### 2026-03-22 Ã¢ÂÂ Enhancement: Gmail Cleanup Labels Instead of Archive
...
- No changes needed to the cleanup endpoints Ã¢ÂÂ they call the same `archiveEmails()` function

**Files changed:**
- `app/lib/google-api.ts` Ã¢ÂÂ Added `getCleanupLabelId()` helper (creates/caches the label), updated `archiveEmails()` to add cleanup label + remove INBOX instead of just removing INBOX

**Commits:** `0376051`

### 2026-03-22 Ã¢ÂÂ Session: iMessage Sync to Dashboard
...
- **API endpoint** (`app/api/sync/texts/route.ts`) Ã¢ÂÂ `POST /api/sync/texts` Ã¢ÂÂ receives messages from the Mac sync script, authenticated via `x-sync-key` header (env var `TEXT_SYNC_SECRET`), and stores them in the `agent_cache` table under key `nathan-recent-texts`.
- **Dashboard integration** Ã¢ÂÂ `app/lib/dashboard-data.ts` already reads from `agent_cache` key `nathan-recent-texts` and includes text messages in the briefing. `app/lib/dashboard-analysis.ts` includes them in the AI analysis prompt under "TEXT MESSAGES" section.
...
- Filters run before push Ã¢ÂÂ junk never reaches the dashboard

**Data Flow:**
```
Mac Messages DB Ã¢ÂÂ sync-messages.py (filter junk) Ã¢ÂÂ Supabase agent_cache Ã¢ÂÂ Dashboard briefing AI
```
...
- Created `app/api/sync/texts/route.ts` Ã¢ÂÂ API endpoint for receiving text messages from Mac sync script
- Created (local Mac) `sync-messages.py` Ã¢ÂÂ Python script to read iMessage DB and push to dashboard
- Created (local Mac) `setup.sh` Ã¢ÂÂ Installer for LaunchAgent automatic sync
- Created (local Mac) `com.bkb.messages-sync.plist` Ã¢ÂÂ LaunchAgent configuration
